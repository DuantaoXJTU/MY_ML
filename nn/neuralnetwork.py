...
Reference
    Blog   :
    Github :https://github.com/lawlite19/MachineLearning_Python/tree/master/NeuralNetwok
    Others :
"""
import numpy as np
...
def neuralNetwork(input_layer_size, hidden_layer_size, out_put_layer):
    data_img = loadmat_data("data_digits.mat")#data_digits.mat是5000个数字
    X = data_img['X']#X是样本 5000行400列，5000个数字，每个数字400个像素点
    y = data_img['y']#Y是标签 5000行 1列
